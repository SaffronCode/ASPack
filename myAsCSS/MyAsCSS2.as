...
package myAsCSS {
	...
	public class MyAsCSS2 {
		...
		public static function setUp(myStage_v:Stage,maxWidthSupport:Number=-1,maxHeightSupport:Number=-1,debugWidth:Number=-1,debugHeight:Number=-1/*,myRationX:Number=-1,myRationY:Number=-1*/){
		...
		public static function add(targetName:String,refrencePosition:Boolean=true, refrenceSize:Boolean=false,resizeX:Boolean=true,resizeY:Boolean = true , clipToTop:Number = Infinity ,clipToLeft:Number = Infinity){
			if(myStage==null){
