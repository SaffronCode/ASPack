...
/**Last edits : 
 * 11/19/2014 > NO_INTERNET_CONNECTION_AVAILABLE event completed
 * 
 * 
 * 
 */
...
////////////////////////////////////////////////
		...
		private function startOver():void
		{
			...
			downloader.addEventListener(DownloadManagerEvents.RELOAD_REQUIRED,reLoadDownload);
		}
		
		private function fileIsNotExists(e:DownloadManagerEvents):void
		{
		...
		public function resume(e:*=null):void
		{
			...
			else
			{
				...
				//this.dispatchEvent(new DownloadManagerEvents(DownloadManagerEvents.NO_INTERNET_CONNECTION_AVAILABLE,0,null,url));
			}
		}
		...
		private function reLoadDownload(e:*=null):void
		{
			...
			if(DownloadManager.autoReload && ( e is DownloadManagerEvents) && (e as DownloadManagerEvents).type == DownloadManagerEvents.RELOAD_REQUIRED)
			{
				resume(e);
			}
			else
			{
				fileIsNotExists(null);
			}
		}
