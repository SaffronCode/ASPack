...
package
{
	...
	public class PhoneNumberEditorAragh
	{
		...
		public static function clearPhoneNumber(num:String):String
		{
			...
			if(num.charAt(0) == '0')
			{
				if(num.charAt(1) == '0')
				{
					...
					else if(num.indexOf('00964')==0 && num.length<String('009647700156676').length)
					{
						//sample 00934
						return 'false'
					}
