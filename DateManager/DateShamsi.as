package DateManager
{
	...
	{
		public static function shamsiToMiladi(date:DateShamsi):Date
		{
			if(date is DateShamsi/* || date is Date*/)
			{
		...
		public static function miladiToShamsi(date:Date):DateShamsi
		{
		...
		public function DateShamsi(year_v:*=null, month_v:*=null, date_v:*=null, hours_v:*=null, minutes_v:*=null, seconds_v:*=null, ms_v:*=null)
		{
